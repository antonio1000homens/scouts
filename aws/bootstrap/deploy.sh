...
ACCOUNT_ID="${EXPECTED_AWS_ACCOUNT:-${AWS_ACCOUNT_ID:-}}"
STACK_NAME="${STACK_NAME:-scouts-account-bootstrap}"
ARTIFACT_BUCKET_NAME="${CODE_BUCKET:-${ARTIFACT_BUCKET_NAME:-}}"
...
: "${ACCOUNT_ID:?EXPECTED_AWS_ACCOUNT or AWS_ACCOUNT_ID must be set}"
: "${ARTIFACT_BUCKET_NAME:?CODE_BUCKET or ARTIFACT_BUCKET_NAME must be set}"
