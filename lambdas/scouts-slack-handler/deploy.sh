...
SCOUTS_REQUEST_QUEUE_URL="${SCOUTS_REQUEST_QUEUE_URL:-https://sqs.${REGION}.amazonaws.com/${EXPECTED_AWS_ACCOUNT}/scoutsRequests}"
SCOUTS_REQUEST_QUEUE_ARN="${SCOUTS_REQUEST_QUEUE_ARN:-arn:aws:sqs:${REGION}:${EXPECTED_AWS_ACCOUNT}:scoutsRequests}"
NFC_QUEUE_URL="${NFC_QUEUE_URL:-https://sqs.${REGION}.amazonaws.com/${EXPECTED_AWS_ACCOUNT}/scoutsRequests}"
NFC_QUEUE_ARN="${NFC_QUEUE_ARN:-arn:aws:sqs:${REGION}:${EXPECTED_AWS_ACCOUNT}:scoutsRequests}"
