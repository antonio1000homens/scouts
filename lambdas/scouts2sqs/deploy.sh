...
SCOUTS_REQUESTS_QUEUE_ARN="${SCOUTS_REQUESTS_QUEUE_ARN:-arn:aws:sqs:${REGION}:${EXPECTED_AWS_ACCOUNT}:scoutsRequests}"
SCOUTS_REQUESTS_QUEUE_URL="${SCOUTS_REQUESTS_QUEUE_URL:-https://sqs.${REGION}.amazonaws.com/${EXPECTED_AWS_ACCOUNT}/scoutsRequests}"
...
DLQ_ARN="${DLQ_ARN:-arn:aws:sqs:${REGION}:${EXPECTED_AWS_ACCOUNT}:scoutsRequestsDLQ}"
DLQ_URL="${DLQ_URL:-https://sqs.${REGION}.amazonaws.com/${EXPECTED_AWS_ACCOUNT}/scoutsRequestsDLQ}"
