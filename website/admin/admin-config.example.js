...
// Optional URL overrides (leave commented to use defaults from admin-script.js)
// window.SCOUTS_AUTH_STATUS_URL = '/admin-api/auth-status';
// window.SCOUTS_REFRESH_URL = '/admin-api/refresh';
// window.SCOUTS2SQS_URL = '/admin-api/persist';
